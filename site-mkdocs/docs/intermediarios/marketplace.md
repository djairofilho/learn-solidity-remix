...
Marketplace: vendedores listam itens, compradores compram com comissão.
 ...
 * 5. Conta 1 chama sacarComissao() para retirar a comissão da plataforma.
 */
...
1. **Deploy** com **Conta 1** (dono da plataforma)
2. Troque para **Conta 2** e chame `listarItem("Notebook", 1000000000000000000)` (1 ETH)
3. Troque para **Conta 3**, defina **Value = 1 ETH** e chame `comprarItem(0)`
4. Troque para **Conta 2** e chame `sacarGanhos()` → recebe **0.95 ETH**
5. Volte para **Conta 1** e chame `sacarComissao()` → recebe **0.05 ETH**

## Use Case

NFT marketplace • Peer-to-peer trading • E-commerce Web3
