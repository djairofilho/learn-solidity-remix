...
Controle de acesso: apenas endereços pré-aprovados podem fazer algo.

**Conceitos ensinados:**
- Array de endereços
- Mapping para verificação rápida
- Access control pattern
- Modifiers reutilizáveis
...
1. **Deploy** com a **Conta 1** (dono)
2. Chame `adicionarAprovado(endereço_da_conta2)`
3. Troque para **Conta 2** e chame `funcaoRestrita()` → funciona
4. Volte para **Conta 1** e chame `removerAprovado(endereço_da_conta2)`
5. Na **Conta 2**, chame `funcaoRestrita()` → **reverte**

## Use Case

Presale • Whitelist em lançamento NFT • Acesso VIP • Beta fechado
