...
1. **Deploy** no Remix VM
2. No campo **Value**, selecione **1 ether**
3. Chame `depositar()` → seu ETH vai pro contrato
4. Chame `meuSaldo()` → deve mostrar **1000000000000000000** (1 ETH em wei)
5. Chame `sacar(200000000000000000)` para sacar **0.2 ETH**
6. Chame `meuSaldo()` → deve mostrar **800000000000000000**
7. Chame `sacarTudo()` → saldo volta a **0**
